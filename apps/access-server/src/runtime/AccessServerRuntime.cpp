...
AccessServerRuntime::AccessServerRuntime(
    ...
    route_store_(script_runtime_.compiler_adapter()),
    service_selector_(nacos_loop, *naming_service_, std::move(selector_options), &gray_store_),
    ...
    server_(accept_loop, http_workers, route_store_, service_selector_.adapter(),
            AccessServerOptions{
