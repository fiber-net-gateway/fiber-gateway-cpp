#ifndef FIBER_HTTP_CLIENT_HTTP2_PUSH_H
#define FIBER_HTTP_CLIENT_HTTP2_PUSH_H
...
class ClientHttp2Push : public common::NonCopyable, public common::NonMovable {
public:
...
#endif // FIBER_HTTP_CLIENT_HTTP2_PUSH_H
