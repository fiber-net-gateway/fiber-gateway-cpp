...
public:
    ...
    [[nodiscard]] static quic::QuicStream::Lease create(Http3ClientConnection &conn, mem::BufPool &pool) noexcept;
...
private:
    ...
    ClientHttp3Request(Http3ClientConnection &conn, mem::BufPool &pool) noexcept;
