...
private:
    ...
    static common::IoErr on_name_raw(void *owner, const std::uint8_t *data, std::size_t len,
                                     Http2HpackDecoder::NameView &out) noexcept;
    static common::IoErr on_name_huffman(void *owner, const std::uint8_t *data, std::size_t len,
                                         Http2HpackDecoder::NameView &out) noexcept;
