...
bool UnixStream::valid() const noexcept { return stream_.valid(); }

int UnixStream::fd() const noexcept { return stream_.fd(); }

const UnixAddress &UnixStream::remote_addr() const noexcept { return remote_addr_; }
